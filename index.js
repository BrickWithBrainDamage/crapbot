                                    ...
                                    try {
                                        if (parsedMessage[1] == undefined) {
                                            ...
                                            if (verifyPronoun(parsedMessage[1])) {
                                                messageAuthor.pronoun = parsedMessage[1].match(/[a-z]{2,8}/i)[0]
                                                message.channel.send(`Changed pronoun for **${message.author.username}** to ${messageAuthor.pronoun}`)
                                            } else {
                                                message.channel.send('Pronoun must be between 2 and 10 characters and not contain any inapporporiate words.')
                                            }
                                        }
